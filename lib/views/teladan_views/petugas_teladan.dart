...
class PetugasTeladanView extends StatelessWidget {
  const PetugasTeladanView({super.key});
  ...
  /// Widget untuk menampilkan gambar petugas dengan medal di tengahnya
  Widget _buildImageWithMedal() {
    return Stack(
